// url=https://www.figma.com/design/3ar2ONJR9DA46bKMhVQ6ZW/?node-id=33418-9958&m=dev
...
// Figma 세트 'checkbox-small' (33418:9958) · variant 6개
...
export default {
  example: figma.code`
BCPCheckbox(checked: ${checked}, size: .small) { _ in }
${disabledModifier}
`,
  imports: ['import BCPDesignSystem'],
  id: 'bcp-checkbox-small',
}
